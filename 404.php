...
<head>
    ...
    <title>404 Page Not Found || Forge</title>
...
<body>
    ...
    <div class="wrapper">
                                ...
                                <li class="mega-container">
                                    ...
                                    <div class="megamenu-area ul-style box-shadow white-bg">
                                        ...
                                        <div class="mega-inner mega-img b-img ptb-40">
                                            <img alt="" src="images/header/header-menu.jpg">
                                        </div>
                                    </div>
                                </li>
                                <li>
                ...
                <div class="row">
                    <div class="col-lg-12">
                        <div class="breadcrumbs-inner">
                            ...
                            <h2 class="breadcrumbs-title text-black m-0">404 page not found </h2>
                            <ul class="top-page">
        ...
        <section id="page-content" class="page-wrapper pt-10">
            ...
            <!-- Banner Area End -->
            <!-- Start 404 Area -->
            <div class="error-text-area pt-90">
                <div class="container">
                    <div class="row">
                        <div class="col-md-12">
                            <div class="error-text text-center gray-ash-bg ptb-140">
                                <div class="error-main-text pb-20">
                                    <h1><strong>404</strong></h1>
                                    <h4>PAGE NOT FOUND</h4>
                                </div>
                                <div class="error-bottom-text">
                                    <h4> OPPS ... WE ARE SORRY</h4>
                                    <p>but the page you looking for is not found</p>
                                    <p>make sure that you have typed the currect URL</p>
                                </div>
                                <h5 class="text-uppercase m-0 pt-50">
                                    <a class="black-btn" href="#">Back to Home page back</a>
                                </h5>
                            </div>
                        </div>
                    </div>
