...
INSERT INTO `keranjang` (`id_keranjang`, `id_user`, `id_order`, `id_product`) VALUES
(1, 1, 1, 1);
...
INSERT INTO `order` (`id_order`, `order_date`, `sts_order`, `ttl_harga`, `cara_pembayaran`) VALUES
(1, '2019-11-12', 'sudah bayar', 10000, 'rekber');
...
INSERT INTO `orderdetails` (`id_orderdetail`, `id_order`, `id_product`, `jumlah`, `sub_total`) VALUES
(1, 1, 1, 10, 1000000);
...
INSERT INTO `product` (`id_product`, `id_user`, `id_category`, `stok`, `nama_product`, `hrg_product`, `foto_product`) VALUES
(1, 1, 1, 21, 'celana', 1000, 'awdawd');
...
INSERT INTO `status` (`id_status`, `id_user`, `id_order`, `nama_status`, `foto_bukti`) VALUES
(1, 1, 1, 'sudah bayar', 'wdawd');
...
INSERT INTO `user` (`id_user`, `id_akses`, `nama_user`, `alamat_user`, `email_user`, `no_telp`, `username`, `password`, `point`) VALUES
(1, 1, 'Akbar Imawan Dwi Cahya', 'Jenggawah', 'akbarimawan18@gmail.com', 123, 'akbar', 'akbar12345', 2000);
...
ALTER TABLE `keranjang`
  ...
  ADD CONSTRAINT `keranjang_ibfk_2` FOREIGN KEY (`id_order`) REFERENCES `order` (`id_order`),
  ADD CONSTRAINT `keranjang_ibfk_3` FOREIGN KEY (`id_product`) REFERENCES `product` (`id_product`);
