...
<head>
    ...
    <title>Order Complete || Forge</title>
                            ...
                            <div role="tabpanel" class="tab-pane fade in active" id="order">
                                ...
                                <div class="col-sm-offset-2 col-sm-5">
                                    <div class="cart-total-area">
                                        ...
                                        <div class="order-button-payment mt-30">
                                            <a href="#" class="cart-button mr-20 text-uppercase">Return To Home</a>
                                            <a href="#" class="cart-button text-uppercase">Continue Shopping</a>
                                        </div>
                                    </div>
